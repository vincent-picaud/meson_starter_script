#+TITLE: The bash script generator 
...
cdata.set('PROJECT_SANDBOXDIR', join_paths(meson.source_root(),'sandbox'))
...
EXAMPLE_PATH           = "@PROJECT_SANDBOXDIR@"
...
#+BEGIN_SRC bash :noweb yes :tangle create_project :shebang "#!/bin/bash" :tangle-mode (identity #o555)
...
if [ $ERROR == 1 ]; then
    ...
    echo ""
    echo "   Creates a directory 'PROJECT_ROOT_DIRECTORY' and populate it with some configuration files."
