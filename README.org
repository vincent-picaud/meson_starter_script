...
Usage: create_project PROJECT_ROOT_DIRECTORY -f
   ...
   Creates a directory 'PROJECT_ROOT_DIRECTORY' and populate it with some configuration files.
...
#+RESULTS:
#+BEGIN_EXAMPLE
+ bin/                           <- creates binaries that are installed
	+ hello.cpp
	+ meson.build
+ doc/
	...
	+ Doxyfile.in
	+ meson.build
+ sandbox/                       <- creates "sandbox" binaries, not installed
	+ hello.cpp
	+ meson.build
+ meson.build                    <- root meson file
+ src/
	+ DemoProject/           <- your "DemoProject" library, installed
		+ hello.cpp
		+ hello.hpp
		+ meson.build
	+ meson.build
+ subprojects/                   <- subprojects, gtest for instance, not installed        
	+ gtest.wrap
+ test/                          <- utest dir (here configured for gtest), not installed    
	+ hello.cpp
	+ meson.build
#+END_EXAMPLE
...
Create directory /home/picaud/Temp/DemoProject/sandbox
Create file      /home/picaud/Temp/DemoProject/sandbox/meson.build
Create file      /home/picaud/Temp/DemoProject/sandbox/hello.cpp
...
[2/12] Compiling C++ object 'sandbox/c590b3c@@hello@exe/hello.cpp.o'.
...
Searching for files in directory /home/picaud/Temp/DemoProject/sandbox
...
[10/12] Linking target sandbox/hello.
